        ...
        <div class="sidebar">
            ...
            <div class="menu-section">
                ...
                <div class="menu-items">
                    ...
                    <!-- 1.2 Barangay Tricycle Route Managemenwwt -->
                    ...
                    <div id="road-monitoring" class="submenu">
                        ...
                        <a href="btrm/staff_driver_association.php" class="submenu-item">Driver Association</a>
                        <a href="btrm/staff_document_upload.php" class="submenu-item">Document Upload</a>
                        <a href="btrm/staff_status_tracking.php" class="submenu-item">Status Tracking</a>
                    </div>
                    ...
                    <div id="patrol-oversight" class="submenu">
                        <a href="mair/staff_report_review.php" class="submenu-item">Report Review</a>
