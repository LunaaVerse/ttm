...
<head>
    ...
    <title>Login - Traffic & Transport Management</title>
    ...
    <style>
        * {
        ...
        .security-features::before {
            ...
            right: 0;
            height: 2px;
            background: linear-gradient(90deg, transparent, var(--icon-teal), transparent);
        ...
        .security-item i {
            width: 40px;
            height: 40px;
            background: linear-gradient(135deg, rgba(15, 118, 110, 0.4), rgba(13, 148, 136, 0.3));
            border-radius: 12px;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .form-group input:focus {
            ...
            box-shadow: 0 0 0 5px rgba(13, 148, 136, 0.15), 0 8px 20px rgba(13, 148, 136, 0.1);
        ...
        .resend-verification {
            margin-top: 20px;
            padding: 20px;
            background: linear-gradient(135deg, rgba(13, 148, 136, 0.08), rgba(15, 118, 110, 0.05));
            border-radius: 15px;
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="login-header">
            ...
            <p>Access your traffic and transport management dashboard</p>
        </div>
