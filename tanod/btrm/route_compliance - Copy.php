                ...
                if (isset($_FILES['evidence_file']) && $_FILES['evidence_file']['error'] == 0) {
                    ...
                    if (move_uploaded_file($_FILES['evidence_file']['tmp_name'], $file_path)) {
                        ...
                        $evidence_stmt->execute([
                            'violation_id' => $violation_id_inserted,
                            'evidence_type' => $evidence_type,
                            'file_name' => $file_name,
...
<body>
            ...
            <div class="menu-section">
                ...
                <div class="menu-items">
                    ...
                    <div id="road-condition" class="submenu">
                        ...
                        <a href="lrcr/follow_up_logs.php" class="submenu-item">Log</a>
                    </div>
                    ...
                    <div id="route-management" class="submenu active">
                        <a href="current_routes.php" class="submenu-item">Current Routes</a>
                        <a href="route_map.php" class="submenu-item">Route Map</a>
                        <a href="follow_up_logs.php" class="submenu-item">Follow-Up Logs</a>
    ...
    <script>
        ...
        function openAddModal() {
            ...
            if (document.querySelector('input[name="edit_compliance_check"]')) {
        ...
        async function editCheck(checkId) {
            try {
                ...
                // Fetch check details
                const response = await fetch(`get_check_edit.php?id=${checkId}`);
                ...
                if (data.success) {
                    ...
                    // Set check date (convert to local datetime format)
                    const checkDate = new Date(data.check.check_date);
                    const localDateTime = checkDate.toISOString().slice(0, 16);
                    document.getElementById('check_date').value = localDateTime;
        ...
        document.getElementById('complianceForm').addEventListener('submit', function(e) {
            // Validate violation fields if violation is checked
            if (document.getElementById('has_violation').checked) {
                ...
                if (!violationId || !vehicleNumber || !violationDetails) {
                    e.preventDefault();
                    Swal.fire({
                        icon: 'warning',
                        title: 'Missing Information',
                        text: 'Please fill in all required violation fields'
                    });
                    return false;
                }
            }
